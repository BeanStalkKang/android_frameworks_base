...
public class PieLayout extends FrameLayout implements View.OnTouchListener {
    ...
    public static final float PIE_ICON_START_SIZE_FACTOR = 1.0f;
    ...
    private void getDimensions() {
        ...
        mSnapRadius = res.getDimensionPixelSize(R.dimen.spie_snap_radius) * mPieScale;
        ...
        mPadding = res.getDimensionPixelSize(R.dimen.spie_padding);
    }
    ...
    private void getColors() {
        ...
        if (snapPaintColor == -2) {
            snapPaintColor = res.getColor(R.color.spie_snap_color);
        }
        ...
        if (backgroundPaintColor == -2) {
            backgroundPaintColor = res.getColor(R.color.spie_overlay_color);
        }
